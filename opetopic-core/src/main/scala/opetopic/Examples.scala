        ...
        Box(
          ...
          Node(
            ...
            Node(
              ...
              Pt(
                Node(
                  Node(Dot(16, S(S(Z))), Node(Leaf(S(S(Z))), Pt(Leaf(S(Z))))),
                  Pt(Leaf(S(Z)))
                )
              )
            )
        ...
        Node(
          Node(
            Box(
              ...
              Node(
                Dot(18, S(S(Z))),
                Node(Leaf(S(S(Z))), Pt(Node(Leaf(S(S(Z))), Pt(Leaf(S(Z))))))
              )
            ),
            Node(
              Node(Dot(19, S(S(Z))), Node(Leaf(S(S(Z))), Pt(Leaf(S(Z))))),
              Pt(
                Node(
                  Node(
                    Dot(20, S(S(Z))),
                    Node(
                      Leaf(S(S(Z))),
                      Pt(Node(Node(Dot(21, S(S(Z))), Leaf(S(Z))), Pt(Leaf(S(Z)))))
                    )
                  ),
                  Pt(Leaf(S(Z)))
                )
          ...
          Pt(
            Node(
              Node(Box(22, Leaf(S(S(Z)))), Node(Leaf(S(S(Z))), Pt(Leaf(S(Z))))),
              Pt(Leaf(S(Z)))
            )
          )
        )
        ...
        Node(
          Node(
            ...
            Node(
              ...
              Node(
                ...
                Pt(
                  Node(
                    Node(Leaf(S(S(S(Z)))), Node(Leaf(S(S(Z))), Pt(Leaf(S(Z))))),
                    Pt(Leaf(S(Z)))
                  )
                )
              )
          ...
          Node(
                ...
                Pt(
                  Node(
                    Node(
                      ...
                      Node(
                        Leaf(S(S(Z))),
                        Pt(Node(Node(Leaf(S(S(S(Z)))), Leaf(S(Z))), Pt(Leaf(S(Z)))))
                      )
                    ),
                    Pt(Leaf(S(Z)))
                  )
            ...
            Pt(
              Node(
                Node(
                  Node(Dot(27, S(S(S(Z)))), Leaf(S(S(Z)))),
                  Node(Leaf(S(S(Z))), Pt(Leaf(S(Z))))
                ),
                Pt(Leaf(S(Z)))
              )
            )
